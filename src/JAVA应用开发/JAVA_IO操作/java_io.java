...
public class java_io {
  public static void main(String[] args) throws Exception/* 注意：出错时 */ {
    ...
    /*
     * File f = new
     * File("/Users/wangyaosheng/Desktop/code/javacode/java_class java/src/JAVA应用开发/JAVA_IO操作"
     * );
     ...
     * 
     * File f2 = new
     * File("/Users/wangyaosheng/Desktop/code/javacode/java_class java/src/JAVA应用开发/JAVA_IO操作/abc.txt"
     * );
     * f2.createNewFile();
    ...
    try {
      ...
      FileInputStream fis = new FileInputStream(
          "/Users/wangyaosheng/Desktop/code/javacode/java_class java/src/JAVA应用开发/JAVA_IO操作/t1.txt");
      // 创建文件输出流，写入t2.txt文件
      FileOutputStream fos = new FileOutputStream(
          "/Users/wangyaosheng/Desktop/code/javacode/java_class java/src/JAVA应用开发/JAVA_IO操作/t2.txt");
    ...
    BufferedReader br = new BufferedReader(
        new FileReader("/Users/wangyaosheng/Desktop/code/javacode/java_class java/src/JAVA应用开发/JAVA_IO操作/t2.txt"));
    while (true) {
